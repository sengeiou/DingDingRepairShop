...
import kotlinx.android.synthetic.main.activity_batch_add_part.view.*
import kotlinx.android.synthetic.main.activity_friend_company.view.*
import kotlinx.android.synthetic.main.item_all_soft_popup.view.mConfirmBTN
import kotlinx.android.synthetic.main.item_all_soft_popup.view.mResetBTN
...
class PartShopActivity : BaseActivityV2(), GoodsMenuFCodeAdapter.MenuListener, GoodsByFCodeAdapter.GoodsByFCodeListener, GoodsAddTrolleyDialog.AddTrolley, ShopBrandAdapter.BranderListener, ShopCategoryAdapter.LinShiAdapterListener, AttrHorizontalAdapter.AttrHorizontalListener, OtherAttrChildAdapter.OtherAttrChildListener, FenLeiAdapter.FenLeiListener, PinPaiAdapter.PinPaiListener, AttrDrawAdapter.AttrDrawListener {
    private val mBinding by lazy { ActivityPartShopBinding.inflate(layoutInflater) }
    override fun getLayout() = mBinding.root

    val mViewModel: PartShopViewModel by lazy { ViewModelProvider(this)[PartShopViewModel::class.java] }

    //配件ID
    val fCode: String? by lazy { intent.getStringExtra(MyConstants.PART_ID) }
    ...
    //额外属性横向列表
    val mAttrHorizontalAdapter by lazy { AttrHorizontalAdapter(this, mAttrList, this) }
    ...
    override fun itemSelect(brandId: String) {
    ...
    //其他属性横向列表被点击(主页) 即将弹出下拉框选择胎面宽度等属性
