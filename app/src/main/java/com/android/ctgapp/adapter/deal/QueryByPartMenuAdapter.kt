...
class QueryByPartMenuAdapter(private val context: Context, private val mList: List<LeftMenuBean>, private val listener: MenuListener) : BaseRecyclerViewAdapter(context, mList) {
    ...
    interface MenuListener {
        fun itemSelect(data: LeftMenuBean)
    }
