...
class AttrHorizontalAdapter(private val context: Context, private val mList: List<OtherAttrEntity.DataBean>, private val listener: AttrHorizontalListener) : RecyclerView.Adapter<AttrHorizontalAdapter.MyViewHolder>() {
    ...
    interface AttrHorizontalListener {
    ...
    override fun getItemCount(): Int {
        val ac = context as PartShopActivity
