...
class EditTextWithDeleteBtnV2(context: Context, attrs: AttributeSet?) : AppCompatEditText(context, attrs) {
    private val mClearDrawable = ResourcesCompat.getDrawable(resources, R.drawable.edit_delete, null)
    private val mSearch = ResourcesCompat.getDrawable(resources, R.drawable.ic_search, null)
    private var hasFocus = false

    init {
        mClearDrawable?.setBounds(
            mSearch!!.intrinsicWidth, 0, mClearDrawable.intrinsicWidth,
