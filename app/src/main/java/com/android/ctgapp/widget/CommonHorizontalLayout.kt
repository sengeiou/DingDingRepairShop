 ...
 *描述: 自定义横向 双TetxView
 */
class CommonHorizontalLayout(context: Context, attributeSet: AttributeSet?) : RelativeLayout(context, attributeSet) {
    var mStartTV: TextView? = null
    var mEndTV: TextView? = null

    init {
        val view = LayoutInflater.from(context).inflate(R.layout.view_common_horizontal_layout, this)
