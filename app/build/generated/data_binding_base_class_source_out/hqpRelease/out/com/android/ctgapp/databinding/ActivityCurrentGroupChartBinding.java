...
public final class ActivityCurrentGroupChartBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCurrentGroupChartBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView mAddIV, @NonNull ImageView mBackIV, @NonNull LinearLayout mBottomLL,
      @NonNull TextView mCardTV, @NonNull SwipeRecyclerView mChartRV,
      @NonNull TextView mCompanyNameTV, @NonNull EditText mET, @NonNull ImageView mFaceButton,
      @NonNull RecyclerView mFaceRV, @NonNull LinearLayout mFunctionLL,
      @NonNull TextView mFunctionOrderBTN, @NonNull TextView mOpenPhotoTV, @NonNull Button mSendTV,
      @NonNull TextView mTakePhotoTV, @NonNull TextView mTalkToNameTV,
      @NonNull RelativeLayout mTitleBarRL, @NonNull VoiceRecorderView mVoiceDialog,
      @NonNull ImageView mVoiceIconTV, @NonNull TextView mVoiceTV,
      @NonNull MP3RecordView viewRecord) {
  ...
  @NonNull
  public static ActivityCurrentGroupChartBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCurrentGroupChartBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_current_group_chart, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCurrentGroupChartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCurrentGroupChartBinding((RelativeLayout) rootView, mAddIV, mBackIV,
          mBottomLL, mCardTV, mChartRV, mCompanyNameTV, mET, mFaceButton, mFaceRV, mFunctionLL,
