...
public final class ActivitySearchGoodsBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView mMenuLeftRV;
  ...
  private ActivitySearchGoodsBinding(@NonNull DrawerLayout rootView, @NonNull TextView mAllSoftBTN,
      ...
      @NonNull RecyclerView mGoodsRV, @NonNull LinearLayout mLinshi,
      @NonNull RecyclerView mMenuLeftRV, @NonNull RecyclerView mMenuRV,
  ...
  @NonNull
  public static ActivitySearchGoodsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySearchGoodsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_search_goods, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySearchGoodsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mMenuLeftRV;
      RecyclerView mMenuLeftRV = rootView.findViewById(id);
      if (mMenuLeftRV == null) {
        break missingId;
      }
      ...
      return new ActivitySearchGoodsBinding((DrawerLayout) rootView, mAllSoftBTN, mArrowIV,
          mAttrHorizontalRV, mBackIV, mBottomButtonLL, mBrandBTN, mCategoryBTN, mConfirmBTN,
          mDrawer, mFenLeiRV, mFenLeiTV, mGoodsRV, mLinshi, mMenuLeftRV, mMenuRV, mOtherAttrDrawRV,
          mPinPaiRV, mPriceIV, mPriceRL, mRefresh, mResetBTN, mSaleIV, mScanIV, mScreenTV,
          mSearchET, mShai, mSortPriceTV, mSortSalesRL, mSortSalesTV, mTrolleyIV);
    }
