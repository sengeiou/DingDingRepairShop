...
public final class ActivityRechargeCommitBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText mTotalPriceTV;
  ...
  private ActivityRechargeCommitBinding(@NonNull LinearLayout rootView, @NonNull CheckBox mAliPayCB,
      @NonNull LinearLayout mAliPayLL, @NonNull Button mConfirmPayBTN,
      @NonNull RelativeLayout mPayButtonRL, @NonNull LinearLayout mTimeCountLL,
      @NonNull TextView mTimeCountTV, @NonNull EditText mTotalPriceTV, @NonNull CheckBox mWeChatCB,
      @NonNull LinearLayout mWeChatLL) {
  ...
  @NonNull
  public static ActivityRechargeCommitBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRechargeCommitBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_recharge_commit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRechargeCommitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText mTotalPriceTV = rootView.findViewById(id);
      ...
      return new ActivityRechargeCommitBinding((LinearLayout) rootView, mAliPayCB, mAliPayLL,
          mConfirmPayBTN, mPayButtonRL, mTimeCountLL, mTimeCountTV, mTotalPriceTV, mWeChatCB,
          mWeChatLL);
    }
