...
public final class ItemAllCouponListBinding implements ViewBinding {
  ...
  private ItemAllCouponListBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull TextView mCouponWayTV, @NonNull TextView mCtgnumTV, @NonNull LinearLayout mDetails,
      @NonNull LinearLayout mHeadLL, @NonNull TextView mLeftAmountTV,
      @NonNull TextView mMoneyUsedTV, @NonNull LinearLayout mParentLL, @NonNull TextView mRuleTV,
      @NonNull TextView mUseTimeTV) {
  ...
  public static ItemAllCouponListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAllCouponListBinding((LinearLayout) rootView, mButtonRL, mButtonTV,
          mChildCouponRV, mCouponBrandTV, mCouponNameHeadTV, mCouponNameTV, mCouponWayTV, mCtgnumTV,
          mDetails, mHeadLL, mLeftAmountTV, mMoneyUsedTV, mParentLL, mRuleTV, mUseTimeTV);
    }
