...
public final class ItemChartTextBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView mChartTextTV;
  ...
  private ItemChartTextBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout mChartContentLL, @NonNull LinearLayout mChartTextParentLL,
      @NonNull TextView mChartTextTV, @NonNull TextView mChartTimeTV, @NonNull ImageView mErrorIV,
  ...
  @NonNull
  public static ItemChartTextBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChartTextBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chart_text, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChartTextBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mChartTextTV;
      TextView mChartTextTV = rootView.findViewById(id);
      if (mChartTextTV == null) {
        break missingId;
      }
      ...
      return new ItemChartTextBinding((LinearLayout) rootView, mChartContentLL, mChartTextParentLL,
          mChartTextTV, mChartTimeTV, mErrorIV, mHeaderLeftCV, mHeaderLeftIV, mHeaderRightCV,
