...
public final class ActivityOrderConfirmBinding implements ViewBinding {
  ...
  private ActivityOrderConfirmBinding(@NonNull LinearLayout rootView, @NonNull ImageView mAddLogoIV,
      ...
      @NonNull EditText mRemarkET, @NonNull TextView mRemissionPriceTV,
      @NonNull LinearLayout mTotalPriceLL, @NonNull TextView mTotalPriceTV,
      @NonNull TextView mTotalRemissionPriceTV) {
  ...
  public static ActivityOrderConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrderConfirmBinding((LinearLayout) rootView, mAddLogoIV, mAddressRL,
          ...
          mNameLL, mNameTV, mOrderRV, mRemarkET, mRemissionPriceTV, mTotalPriceLL, mTotalPriceTV,
          mTotalRemissionPriceTV);
    }
