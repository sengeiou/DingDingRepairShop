...
public final class ItemCouponListBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView mCtgnumTV;
  ...
  private ItemCouponListBinding(@NonNull LinearLayout rootView, @NonNull RelativeLayout mButtonRL,
      ...
      @NonNull TextView mCouponWayTV, @NonNull TextView mCtgnumTV, @NonNull LinearLayout mHeadLL,
  ...
  public static ItemCouponListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mCtgnumTV;
      TextView mCtgnumTV = rootView.findViewById(id);
      if (mCtgnumTV == null) {
        break missingId;
      }
      ...
      return new ItemCouponListBinding((LinearLayout) rootView, mButtonRL, mButtonTV, mCheak,
          mCouponBrandTV, mCouponNameHeadTV, mCouponNameTV, mCouponWayTV, mCtgnumTV, mHeadLL,
          mLeftAmountTV, mMoneyUsedTV, mParentLL, mRuleTV, mUseTimeTV);
    }
